;*****************start of the kernel code of DHP_OS***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to DHP_OS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO DHP_OS ************', 0x00 
	...
	wel7 db ' version 1.0.0 of DHP_OS From U.D.H.Perera - SE/2019/042', 0x00
	...
	strPrompt		db	"DHP_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"DHP", 0x00	;OS details
